...
class CustomTextField extends StatelessWidget {
  ...
  TextEditingController ?controller;
  CustomTextField({
    Key? key,required this.isClickable,this.iconName,required this.hindText,required this.readOnly,required this.haveBorder,required this.textAlign,required this.controller,this.haveIcon=true
  }) : super(key: key);
